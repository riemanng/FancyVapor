...
struct CRUDChildrenController<T: Model & CRUDModel,
                              ParentT: Model>: CRUDChildrenControllerProtocol where T.IDValue: LosslessStringConvertible, ParentT.IDValue: LosslessStringConvertible {
